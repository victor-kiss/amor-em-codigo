...
export default function Home() {
  ...
  const MusicsComponent = dynamic(() => import('@/app/components/musics/Musics'), { ssr: false });
  const Message = dynamic(() => import('@/app/components/messages/Messages'), { ssr: false });
  return (
    <div className="relative flex flex-col justify-center items-center min-h-screen overflow-x-hidden text-gray-200">
      ...
      <section className="relative w-full h-screen p-6 flex flex-col items-center justify-center sm:text-center">
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }} // Alterado
          whileInView={{ opacity: 1, y: 0 }} // Alterado
          transition={{ type: "spring", stiffness: 100, damping: 20, delay: 0.2 }} // Alterado
          className="my-6"
        >
          <Link
            href="#message"
